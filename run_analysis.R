...
download.file(fileUrl,destfile="F:/one drive/R/data.zip")
unzip(zipfile="F:/one drive/R/data.zip")
setwd("F:/one drive/R/UCI HAR Dataset")
...
View(Data2)
write.table(Data2, "tidy_data_set.txt", row.names = FALSE, quote = FALSE)